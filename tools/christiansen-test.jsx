...
const items = [
  ...
  // CMK folding-lifting positions: TWO stacked boxes each, Aventos hardware per tier
  it('W3330', 54, 'upper', 33, 30, 13, { yMount: 54, mods: { AVENTOS_HK: 1 } }),   // lifting cabinet (768mm)

...
export function scoreAgainstTraining(layoutResult) {
  ...
  const TRAINING_PROFILES = [
    ...
    // ── Soderstrom whole-house (June 2026, real W.W. Wood/Shiloh SHI342 quotes;
    //    source:'order_2026'). Shiloh framed, Malibu flush-inset, flush toe kicks,
    //    5/8 hdwd dovetail + Blum FEG guides throughout. ──
    { id: "soderstrom_kitchen", name: "Soderstrom Kitchen + Island Bar", layout: "l-shape", gola: false, twoTone: true, island: true, b2td: false, dp: true, stacked: false, cabs: [28, 45], price: "$61K list", sophistication: "very_high", source: "order_2026", notes: "Shiloh Malibu flush inset; two-tone: Polar-painted Maple perimeter + Rift Cut White Oak (Straw) island/bar; 48\" range top w/ 30% sq-mod, double-oven+micro flush-inset tall (FIOM3393-27), paneled fridge wall (6 REF sq-in panels), DM aluminum waste base, apron sink base, inset DW front panel, RH8 hood w/ matching oak band, inset false-door end panels shipped loose for onsite scribe, bar with glass-door W4536 + LED prep, beverage-center front, furniture base mould on bar." },
    { id: "soderstrom_primary", name: "Soderstrom Primary Bath + Hall", layout: "single-wall", gola: false, twoTone: false, island: false, b2td: false, dp: false, stacked: false, cabs: [8, 12], price: "$9K list", sophistication: "very_high", source: "order_2026", notes: "Vanity-tall suite in Rift Cut White Oak inset: VTB12L + VTSB24 pair + VTB24-3 pair + grooming organizer (VTGO12) + U2493-2D hall utility; furniture crown in hall; tall fillers." },
    { id: "soderstrom_laundry", name: "Soderstrom 1st-Floor Laundry", layout: "l-shape", gola: false, twoTone: false, island: false, b2td: false, dp: false, stacked: false, cabs: [10, 16], price: "$12K list", sophistication: "high", source: "order_2026", notes: "Polar-painted Maple inset; RW3015-30D over fridge, W3036 upper run, full-drawer base w/ rollouts (B30-RT-1DR), sink base full drawer, U2493L utility at 18\" depth option, end panels FTK both sides, finished-ply side." },
    // ── Drive corpus (real W.W. Wood orders/quotes mined June 2026 from the
    //    Pinnacle project archive; source:'order_archive'). ──
    { id: "josh_huang", name: "Josh Huang", layout: "u-shape", gola: false, twoTone: false, island: false, b2td: false, dp: false, stacked: false, cabs: [18, 30], price: "$24K list", sophistication: "high", source: "order_archive", notes: "Full TFL (Battle Creek Oak) slab kitchen, Metropolitan vertical grain; two blind corners w/ full-swing wire shelves; 193\" tall appliance wall (double UT3693 + O3093); pull-out shelf and tray-divider bases; partial plywood." },
    { id: "bissegger_builtins", name: "Bissegger Great Room & Bar", layout: "single-wall", gola: false, twoTone: false, island: false, b2td: false, dp: false, stacked: false, cabs: [25, 45], price: "$79K list", sophistication: "very_high", source: "order_archive", notes: "Rift Cut White Oak Yosemite Brown built-ins: pocket-door wall garages ($4.3k), 6 lit floating shelves, reeded-panel bar doors, paneled fridge pair (REF $3.5k each), toe-kick light prep on nearly every base, paper-towel/utensil pullouts, apron sink." },
    { id: "mccomb", name: "McComb", layout: "u-shape", gola: false, twoTone: true, island: true, b2td: false, dp: false, stacked: false, cabs: [25, 40], price: "$39K list", sophistication: "very_high", source: "order_archive", notes: "Two-tone paint (Shoji White perimeter / Slate Tile island), Scottsdale FP; twin right-angle super susans; heavy-duty 2-drawer base; wine-shelf base; oven/micro tall; Scottsdale bar back on island; 3/4\" dovetail+FEG $129/drawer." },
    { id: "los_alamos_1934", name: "1934 Los Alamos Kitchen", layout: "l-shape", gola: false, twoTone: false, island: true, b2td: false, dp: false, stacked: true, cabs: [18, 30], price: "$22K list", sophistication: "high", source: "order_archive", notes: "Alder + Caviar stain; stacked uppers w/ 15\" top sections; 3 stock floating shelves; super-susan corner; island clad in loose doors w/ furniture toe; 102\" fridge panels; crown + traditional trim." },
    { id: "eddie", name: "Eddie's Kitchen", layout: "l-shape", gola: false, twoTone: false, island: true, b2td: false, dp: false, stacked: false, cabs: [18, 30], price: "$24K list", sophistication: "high", source: "order_archive", notes: "Maple + Evergreen Fog paint, Malibu FP; super-susan + wall blind corner; island with 13\"-deep FHD backs (N/C depth option) and edge-banded panels; stock floating shelves; door-mounted waste; won against an RTA import bid at ~half the price." },
    { id: "ruhi", name: "Ruhi Kitchen", layout: "l-shape", gola: false, twoTone: false, island: true, b2td: false, dp: false, stacked: false, cabs: [20, 32], price: "$46K list", sophistication: "very_high", source: "order_archive", notes: "Shiloh framed 1¼\" overlay (Malibu FOVL: $26/door + $67/front), Maple + Shoji White; RH68 48\" hood ($4.5k); 2-tier drawer base; drawer microwave; oversize loose doors as island/appliance panels; 93\" pantry w/ rollouts." },
    { id: "dolfin_isle", name: "Dolfin Isle", layout: "u-shape", gola: false, twoTone: false, island: true, b2td: false, dp: false, stacked: false, cabs: [18, 30], price: "$20-24K list", sophistication: "high", source: "order_archive", notes: "White Oak natural, dual-quoted Eclipse frameless vs Shiloh flush inset (+17%); twin appliance-garage towers (WGD2454) flanking window; 4-tier pull-out bases; 4 floating shelves + component bar back island; CA Title 24 remodel." },
    { id: "timeless_commercial", name: "Timeless Commercial Kitchen", layout: "galley", gola: true, twoTone: false, island: false, b2td: true, dp: false, stacked: true, cabs: [40, 70], price: "$91K list", sophistication: "very_high", source: "order_archive", notes: "Commercial/office kitchen: full gola continuous-pull system (FC- channel cabinets + GCP/GLP profiles), Rift Cut White Oak Malibu Reeded, 45 Legrabox stainless drawers ($372 ea), six 108\" oven towers, Aventos HK lifts, range top bases." },
    { id: "wrs_beatty", name: "WRS Beatty Kitchen", layout: "u-shape", gola: false, twoTone: false, island: true, b2td: false, dp: true, stacked: true, cabs: [25, 40], price: "$45K list", sophistication: "very_high", source: "order_archive", notes: "Rift Cut White Oak Almond; integrated-appliance panel program (3-pc Sub-Zero fridge set, Cove DW, ice maker, beverage center — all per-sq-in); stacked bifold uppers open to countertop; turned-leg furniture island w/ component backs; knife-insert + 4-tier pullout bases; valances." },
    { id: "spector", name: "Spector", layout: "l-shape", gola: false, twoTone: false, island: true, b2td: false, dp: false, stacked: false, cabs: [18, 30], price: "$28K list", sophistication: "high", source: "order_archive", notes: "Hickory natural (0% species), plywood +10%; ~108\" island w/ applied-door back panels; rollout bases + utility tower w/ rollouts; 13\"-deep FHD bases; glass-ready doors w/ finished interiors (25%); microwave wall cabinet." },
    { id: "owen", name: "Owen", layout: "u-shape", gola: false, twoTone: true, island: true, b2td: false, dp: true, stacked: false, cabs: [22, 35], price: "$42K list", sophistication: "very_high", source: "order_archive", notes: "Two-tone: Maple + Light French Gray perimeter / Rustic Hickory Burnt Sugar island; flush-inset coffee/oven tower (FIO2790 + 50% mod); turned legs + peninsula columns; DW panel; removable toe kicks throughout; door-mounted aluminum waste." },
    { id: "diehl", name: "DeLawyer Diehl House", layout: "l-shape", gola: false, twoTone: false, island: false, b2td: false, dp: false, stacked: false, cabs: [15, 25], price: "$19K kitchen + baths/laundry", sophistication: "standard", source: "order_archive", notes: "Whole house Eclipse: kitchen w/ super susan + square wall corner, quoted in Maple/Cherry/Alder ladder (8/10/12%); vanity-tall baths; laundry w/ uppers; glass display upper w/ finished interior; lap drawer." },
    // ── 2025 trend references (designer inspiration kitchens; aesthetic fingerprints,
    //    not Eclipse order data; source:'trend_2025'). style ∈ sleek_slab | warm_organic
    //    | two_tone_transitional. notes capture the signature look / any design lesson. ──
    { id: "ssb_sherman_oaks", name: "Interiors by SSB \u2014 Sherman Oaks", layout: "l-shape", gola: true, twoTone: false, island: true, b2td: false, dp: false, stacked: false, cabs: [25, 45], sophistication: "very_high", source: "trend_2025", style: "sleek_slab", notes: "Full-height stone slab backsplash; waterfall island; pro range centered with a stone/wood-clad hood surround; black steel-framed glass display cabinets; white-oak handleless slab." },
    { id: "annecarr_veined", name: "Anne Carr \u2014 Veined Stone Island", layout: "single-wall", gola: true, twoTone: false, island: true, b2td: false, dp: false, stacked: false, cabs: [18, 32], sophistication: "very_high", source: "trend_2025", style: "sleek_slab", notes: "Dramatic veined-stone waterfall island; full-height slab backsplash; walnut handleless slab; integrated LED light reveal; no wall cabinets." },
    { id: "cosentino_sensa", name: "Cosentino Sensa Vancouver", layout: "single-wall", gola: true, twoTone: false, island: false, b2td: false, dp: false, stacked: false, cabs: [15, 28], sophistication: "very_high", source: "trend_2025", style: "sleek_slab", notes: "Continuous countertop-to-full-height slab backsplash; integrated floating stone shelf with LED; integrated panel-ready appliances; rift-oak vertical-grain slab." },
    { id: "wilmyrs_walnut", name: "wil.myrs \u2014 Sherman Oaks New Build", layout: "l-shape", gola: true, twoTone: false, island: true, b2td: false, dp: false, stacked: false, cabs: [25, 45], sophistication: "very_high", source: "trend_2025", style: "sleek_slab", notes: "Floor-to-ceiling walnut handleless slab; full-height slab backsplash; waterfall island with counter-depth seating; no uppers on the range wall." },
    { id: "miralis_plaster", name: "Miralis / Otley \u2014 Plaster Hood", layout: "u-shape", gola: false, twoTone: false, island: true, b2td: false, dp: false, stacked: false, cabs: [25, 45], sophistication: "very_high", source: "trend_2025", style: "warm_organic", notes: "Full-height slab backsplash; sculptural plaster range hood; warm wood island with woven-leather stools; brass." },
    { id: "ene_med", name: "ENE Builders \u2014 Mediterranean Organic", layout: "l-shape", gola: false, twoTone: false, island: true, b2td: false, dp: false, stacked: false, cabs: [22, 40], sophistication: "high", source: "trend_2025", style: "warm_organic", notes: "Arched plaster range niche clad in handmade (zellige) tile; shaker/inset white-oak; marble waterfall island; brass pot-filler + cup pulls; arched openings." },
    { id: "citysage_oak", name: "City Sage \u2014 White Oak Slab", layout: "single-wall", gola: true, twoTone: false, island: true, b2td: false, dp: false, stacked: false, cabs: [20, 38], sophistication: "very_high", source: "trend_2025", style: "sleek_slab", notes: "White-oak handleless slab; integrated panel appliances. DESIGN LESSON: don't place the prep sink directly across from the fridge; give the fridge a real landing (>=15\"), not a skinny strip; keep the prep zone adjacent to the fridge." },
    { id: "sheahsmith_twotone", name: "Shea H. Smith \u2014 Two-Tone", layout: "l-shape", gola: false, twoTone: true, island: true, b2td: false, dp: false, stacked: false, cabs: [25, 45], sophistication: "high", source: "trend_2025", style: "two_tone_transitional", notes: "Two-tone: painted creamy-white uppers (BM Creamy White OC-7) + stained white-oak base/island (lightened SW Antique Barrel); marble counters; brass; inset." },
  ];
